...
\begin{center}
\ \\
\scalebox{3}{\texttt{𝕋𝕙𝕖 ℙ𝕦𝕡𝕡𝕖 𝕊𝕖𝕢𝕦𝕖𝕟𝕔𝕖𝕤}}\\
\ \\
...
\hline
$\texttt{IntCat}$ & \texttt{D(}∞\texttt{-Cat)} & B⃗ & E⃗ & $\texttt{InfPreShf}$ & \texttt{D(}∞\texttt{-Cat/C)} & b⃗ & e⃗\\
\hline
$\texttt{IntGrpd}$ & \texttt{D(}∞\texttt{-Grpd)} & B⃡ & E⃡ & $\texttt{IntAct}$ & \texttt{D(}∞\texttt{-Grpd/G)} & b⃡ & e⃡\\
 \hline
$\texttt{IntGrp}$ & \texttt{D(}∞\texttt{-Grpd₀)} & B & E & $\texttt{IntAct₀}$ & \texttt{D(}∞\texttt{-Grpd₀/G₀)} & b & e\\
 \hline
\end{tabular}}
\end{center}}
\ \\
...
\begin{center}
\ \\
\scalebox{0.85}{$\cdots$ ⭢ π⃗₁.obj C ⭢ π⃗₁.obj D $\circlearrowright$ π⃗₀.obj ((𝟙 C) • ((ω⃗.hom (𝟙 D)).hom f) ) ⭢ (π⃗₀.obj C) ⭢ (π⃗₀.obj D)}\\
\ \\
\scalebox{0.85}{$\cdots$ ⭢ π⃡₁.obj E ⭢ π⃡₁.obj B $\circlearrowright$ π⃡₀.obj ((𝟙 B) • ((ω⃡.hom (𝟙 C)).hom f) ) ⭢ (π⃡₀.obj E) ⭢ (π⃡₀.obj B)}\\
\ \\
\scalebox{0.85}{$\cdots$ ⭢ π₁.obj E₀ ⭢ π₁.obj B₀ ⭢ π₀.obj ((𝟙 B₀) • ((ω.hom (𝟙 B₀)).hom f)) ⭢ π₀.obj (E₀) ⭢ π₀.obj(B₀)}\\
\ \\
\end{center}
\end{tcolorbox}
\end{center}
...
\hline
 ...
 \hline \hline
 \multicolumn{2}{||c||}{\texttt{Chapter 11: }The Puppe Sequence for ∞-Groupoids} \\
\hline \hline
The Puppe sequence & \scalebox{0.8}{$\cdots$ ⭢ π⃡₁(E) ⭢ π⃡₁(B) $\circlearrowright$ π⃡₀(ω⃡ (𝟙 C) f) ⭢ π⃡₀(E) ⭢ π⃡₀(B)} \\
\hline \hline
\multicolumn{2}{||c||}{\texttt{Chapter 12: }The Groupoid Fixed Point Principals} \\
\hline \hline
...
\hline \hline
\multicolumn{2}{||c||}{\texttt{Chapter 13: }The Category of Pairs of ∞-Groupoids} \\
\hline \hline
...
\hline \hline
\multicolumn{2}{||c||}{\texttt{Chapter 14: }∞\texttt{-Cat}} \\
\hline \hline
...
π⃗ₙ : ∞-Cat ⭢ Set & The connected components functors\\
 \hline \hline
 \multicolumn{2}{||c||}{\texttt{Chapter 15: }The Whitehead Theorem for ∞-Categories} \\
\hline \hline
...
p⃗ C : D(∞-Cat⁄C) ⭢ InfPreShf D(∞-Cat⁄C) & The (remembrant derived) directed homotopy pullback functor\\
 \hline \hline
 \multicolumn{2}{||c||}{\texttt{Chapter 17: }The Puppe Sequence for ∞-Categories} \\
\hline \hline
The Puppe sequence & \scalebox{0.8}{$\cdots$ ⭢ π⃗₁(C) ⭢ π⃗₁(D) $\circlearrowright$ π⃗₀(ω⃗ (𝟙 D) f) ⭢ π⃗₀(C) ⭢ π⃗₀(D)}  \\
\hline \hline
\multicolumn{2}{||c||}{\texttt{Chapter 18: }The Categorical Fixed Point Principals} \\
\hline \hline
...
\hline \hline 
\multicolumn{2}{||c||}{\texttt{Chapter 19: }The Category of Pairs of ∞-Categories} \\
\hline \hline
...
{\bf The main goals of this repository is to define three variations of the Puppe sequence in Lean 4 and to prove their exactness}:
...
\section{The Internal Group Delooping Principal}
...
\section{The Internal Group Action Delooping Principal}
...
\chapter{Chapter 5: B and Abelian Groups}
